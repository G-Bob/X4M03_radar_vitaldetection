...
function [resp_list,heart_list,Timelist] = X4record1(record_duration,record_person,record_activity,COMPORT)
...
[~,~] = Rate_estimation(resp_sig,fs_sample,'r');
figure(5);
[~,~] = Rate_estimation(heart_sig,fs_sample,'h');
subplot(211)
[resp_rate] = Rate_estimation_fft(resp_sig,fs_sample,'r');
subplot(212)
[heart_rate] = Rate_estimation_fft(heart_sig,fs_sample,'h');
